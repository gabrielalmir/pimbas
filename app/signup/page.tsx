...
export default function SignupPage() {
  ...
  return (
    <Page className="grid content-center lg:grid-cols-[minmax(0,0.95fr)_minmax(360px,0.72fr)] lg:items-center lg:gap-8">
        ...
        <div className="grid h-full content-between gap-10">
          <div>
            ...
            <p className="mt-4 max-w-md text-base text-primary-foreground/78">
              Crie sua conta para organizar partidas, rankings e torneios de pimbolim sem planilha e
              sem debate no fim da rodada.
            </p>
          </div>
      ...
      <SectionCard title="Criar conta" className="mt-4 lg:mt-0">
        <form
        ...
        >
          ...
          <Button
            ...
            disabled={busy || !name.trim() || !email.trim() || pass.length < 8}
          >
            Criar conta
